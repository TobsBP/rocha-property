import type { GallerySale } from "./gallery-sales.types";

export const MOCK_GALLERY_SALES: GallerySale[] = [
	{
		id: "b3d2f1a0-1234-4abc-9def-000000000001",
		soldAt: "2026-03-15T00:00:00.000Z",
		description: "Casa em condomínio fechado vendida em tempo recorde.",
		imgUrls: [
	...
	{
		id: "b3d2f1a0-1234-4abc-9def-000000000002",
		soldAt: "2026-02-20T00:00:00.000Z",
		description:
			"Apartamento moderno no coração dos Jardins negociado com sucesso.",
		imgUrls: [
	...
	{
		id: "b3d2f1a0-1234-4abc-9def-000000000003",
		soldAt: "2026-01-10T00:00:00.000Z",
		description:
			"Cobertura duplex com piscina privativa entregue ao novo proprietário.",
		imgUrls: [
	...
	{
		id: "b3d2f1a0-1234-4abc-9def-000000000004",
		soldAt: "2025-12-05T00:00:00.000Z",
		description:
			"Loft contemporâneo em Vila Nova Conceição fechado em 15 dias.",
		imgUrls: [
	...
	{
		id: "b3d2f1a0-1234-4abc-9def-000000000005",
		soldAt: "2025-11-18T00:00:00.000Z",
		description:
			"Apartamento clássico em Higienópolis transferido para família.",
		imgUrls: [
	...
	{
		id: "b3d2f1a0-1234-4abc-9def-000000000006",
		soldAt: "2025-10-30T00:00:00.000Z",
		description:
			"Casa térrea em Alphaville vendida acima do valor de avaliação.",
		imgUrls: [
